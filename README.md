...
## Aim
This repository aims to clearly show and explain the methods, documents and code used throughout the project. The aim of the project can be regarded as generation of structural and functional predictions of the relevant genes to compare the contrasting conditions as diploidy and tetraploidy. 
